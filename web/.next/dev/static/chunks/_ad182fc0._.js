...
"[project]/components/Walkthrough.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Walkthrough() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Walkthrough.useEffect": ()=>{
            ...
            ;
            // Dynamic import intro.js
            __turbopack_context__.A("[project]/node_modules/intro.js/intro.module.js [app-client] (ecmascript, async loader)").then({
                "Walkthrough.useEffect": (introJsModule)=>{
                    ...
                    const walkthroughShown = sessionStorage.getItem(`walkthrough_${pathname}`);
                    // Show walkthrough on first visit to each page
                    if (!hasCompletedWalkthrough && !walkthroughShown) {
                        setTimeout({
                            "Walkthrough.useEffect": ()=>{
                                const steps = getStepsForPage(pathname);
                                if (steps.length > 0) {
                                    const intro = introJs();
                                    // Set up event handlers using DOM events (intro.js v8 uses custom events)
                                    const handleComplete = {
                                        "Walkthrough.useEffect.handleComplete": ()=>{
                                            sessionStorage.setItem(`walkthrough_${pathname}`, 'true');
                                            document.removeEventListener('introjs:complete', handleComplete);
                                            document.removeEventListener('introjs:exit', handleExit);
                                        }
                                    }["Walkthrough.useEffect.handleComplete"];
                                    const handleExit = {
                                        "Walkthrough.useEffect.handleExit": ()=>{
                                            sessionStorage.setItem(`walkthrough_${pathname}`, 'true');
                                            document.removeEventListener('introjs:complete', handleComplete);
                                            document.removeEventListener('introjs:exit', handleExit);
                                        }
                                    }["Walkthrough.useEffect.handleExit"];
                                    // Listen for intro.js events before starting
                                    document.addEventListener('introjs:complete', handleComplete);
                                    document.addEventListener('introjs:exit', handleExit);
                                    intro.setOptions({
                                        steps,
                                        showProgress: true,
                                        showBullets: true,
                        ...
                        }["Walkthrough.useEffect"], 1000);
                    }
                }
            }["Walkthrough.useEffect"]).catch({
                "Walkthrough.useEffect": (error)=>{
                    console.warn('Failed to load intro.js:', error);
                }
            }["Walkthrough.useEffect"]);
        }
    }["Walkthrough.useEffect"], [
...
_s(Walkthrough, "V/ldUoOTYUs0Cb2F6bbxKSn7KxI=", false, function() {
    return [
...
function getStepsForPage(pathname) {
    ...
    switch(pathname){
        case '/':
            steps.push({
                title: 'Welcome to Insight Agent IDP!',
                intro: 'This is your dashboard. Here you can see key metrics and quick actions.',
                element: 'h1'
            }, {
                title: 'Quick Stats',
                intro: 'View your total transactions, spending, documents, and average transaction amounts at a glance.',
                element: '.grid'
            }, {
                title: 'Quick Actions',
                intro: 'Use these shortcuts to upload documents, view analytics, or check for anomalies.',
                element: '.bg-white.shadow'
            });
            break;
        case '/analytics':
            steps.push({
                title: 'Analytics Dashboard',
                intro: 'Explore your spending trends, vendor statistics, and category breakdowns.',
                element: 'h1'
            }, {
                title: 'Time Series Charts',
                intro: 'View monthly and daily spending trends to understand your expense patterns.',
                element: '.bg-white.shadow'
            }, {
                title: 'Forecast',
                intro: 'See predicted spending for the next few months based on historical data.',
                element: '.bg-white.shadow'
            });
            break;
        case '/documents':
            steps.push({
                ...
                intro: 'Upload, view, and manage all your documents here.',
                element: 'h1'
            }, {
                title: 'Upload Documents',
                intro: 'Click here to upload new invoices or receipts. They will be automatically processed.',
                element: 'label[for="file-upload"]'
            }, {
                title: 'Document List',
                intro: 'View all your processed documents. Click on any document to see extracted data and make corrections.',
                element: '.grid'
            });
            break;
        case '/chat':
            steps.push({
                title: 'Chat with Insight Agent',
                intro: 'Ask natural language questions about your documents and transactions.',
                element: 'h1'
            }, {
                title: 'Ask Questions',
                intro: 'Try asking: "What are my top vendors?" or "Show me spending trends"',
                element: 'form'
            });
            break;
        case '/anomalies':
            steps.push({
                ...
                intro: 'Automatically detect duplicates, unusual amounts, and missing fields in your documents.',
                element: 'h1'
            }, {
                title: 'Anomaly List',
                intro: 'Review detected issues sorted by severity. High priority items need immediate attention.',
                element: '.space-y-4'
            });
            break;
    }
...
function startWalkthrough(steps) {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    __turbopack_context__.A("[project]/node_modules/intro.js/intro.module.js [app-client] (ecmascript, async loader)").then((module)=>{
...
var _c;
__turbopack_context__.k.register(_c, "Walkthrough");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/node_modules/react-error-boundary/dist/react-error-boundary.development.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
const ErrorBoundaryContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
const initialState = {
    didCatch: false,
    error: null
};
    ...
    render() {
        ...
        if (didCatch) {
            ...
            if (typeof fallbackRender === "function") {
                ...
                childToRender = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"])(FallbackComponent, props);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"])(ErrorBoundaryContext.Provider, {
            value: {
                didCatch,
                error,
                resetErrorBoundary: this.resetErrorBoundary
...
function useErrorBoundary() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(ErrorBoundaryContext);
    assertErrorBoundaryContext(context);
    const [state, setState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        error: null,
        hasError: false
    });
    const memoized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
...
//# sourceMappingURL=_ad182fc0._.js.map